...
Calendar, Search, AI Chat, Settings/2FA management, Analytics, Achievements, Notifications, Command Palette, and a confetti moment in the journal editor were added after the initial slice. Voice dictation is still intentionally not in this app - see below and the Phase 11 plan for the full deferral list.
